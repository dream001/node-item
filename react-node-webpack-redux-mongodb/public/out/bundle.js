	...
	var Notes = function (_React$Component) {
		...
		_createClass(Notes, [{
			...
			value: function render() {
				var notes = this.props.notes; //也就是const notes=this.props.notes,这个this.props肯定包含dispatch函数的方法对象，因为用了connect所以又有了notes这个属性
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 服务端渲染须知:
	// 异步 action creator 对于做服务端渲染非常方便。你可以创建一个 store，dispatch 一个异步 action creator，
	// 这个 action creator 又 dispatch 另一个异步 action creator 来为应用的一整块请求数据，同时在 Promise 完成和结束时才 render 界面
...
/***/ function(module, exports, __webpack_require__) {
	...
	//处理笔记初始化、添加及删除请求
	// action={ type : INIT_NOTES, notes : notes }  其中notes是数据
	function notes() {
		var state = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];
		var action = arguments[1];
